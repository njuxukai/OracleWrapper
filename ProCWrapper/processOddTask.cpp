...
static unsigned int sqlctx = 10387011;
...
#line 7 "processOddTask.pc"

void processOddTask(int task, int thid, sql_context ctx)
{
	/* EXEC SQL CONTEXT USE : ctx; */ 
#line 10 "processOddTask.pc"

	/* EXEC SQL BEGIN DECLARE SECTION; */ 
#line 11 "processOddTask.pc"

	int cal = 0;
	int value = 0;
	/* EXEC SQL END DECLARE SECTION; */ 
#line 14 "processOddTask.pc"

	cal = 3 * task;
	/* EXEC SQL SELECT : cal INTO : value FROM DUAL; */ 
#line 16 "processOddTask.pc"
